...
export const metadata: Metadata = {
  title: 'Terms & Conditions - Opacity',
  description: 'Terms and conditions for Opacity - Photo Filter & Adjustment App for iOS',
  icons: {
      ...
      <main className="flex-1 container px-4 md:px-6 py-12">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none text-white/80 space-y-6">
            <p>
              These terms and conditions apply to the Opacity app (hereby referred to as "Application") for mobile devices that was created by Lauper Labs (hereby referred to as "Service Provider") as a Freemium service.
            </p>
            ...
            <section>
              ...
              <div className="bg-violet-500/10 border border-violet-500/20 rounded-lg p-4">
                <p className="text-violet-400 font-semibold mb-2">Apple App Store Subscriptions:</p>
                <p className="mb-3">
                ...
                <ol className="list-decimal pl-6 space-y-2 text-white/80">
                  ...
                  <li>Find Opacity in your list of subscriptions</li>
            ...
            <section>
              ...
              <p>
                These terms and conditions are effective as of 2025-11-15
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at hello@lauperlabs.com
              </p>
            </section>
          </div>
        </div>
      ...
      <footer className="w-full border-t border-white/10 py-6">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <nav className="flex gap-4 sm:gap-6">
            ...
            <Link href="/opacity/privacy" className="text-xs text-white/70 hover:text-white">
              Privacy Policy
            </Link>
          </nav>
        </div>
