...
export const metadata: Metadata = {
  title: 'Terms & Conditions - PeekLUT',
  description: 'Terms and conditions for PeekLUT - Photo & Video LUT Editor for iOS',
  icons: {
      ...
      <main className="flex-1 container px-4 md:px-6 py-12">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none text-white/80 space-y-6">
            <p>
              These terms and conditions apply to the PeekLUT app (hereby referred to as "Application") for mobile devices that was created by Lauper Labs (hereby referred to as "Service Provider") as a Freemium service.
            </p>
            ...
            <section>
              ...
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                ...
                <p>
                  The Application may implement rate limits on certain features, including but not limited to LUT processing and export functionality. These limits are in place to ensure fair usage and maintain service quality for all users. Excessive usage that violates these limits may result in temporary or permanent restriction of service.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <ol className="list-decimal pl-6 space-y-2 text-white/80">
                  ...
                  <li>Find PeekLUT in your list of subscriptions</li>
            ...
            <section>
              ...
              <p>
                If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at hellopeeklut@icloud.com
              </p>
            </section>
          </div>
        </div>
      ...
      <footer className="w-full border-t border-white/10 py-6">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <nav className="flex gap-4 sm:gap-6">
            ...
            <Link href="/peeklut/privacy" className="text-xs text-white/70 hover:text-white">
              Privacy Policy
            </Link>
          </nav>
        </div>
